...
int main(void)
{
    ...
    do
    {
        ...
        case 1: // 1) Leer fichero.
            ...
            break;
        case 2: // 2) Construir estructuras.
        ...
        case 4: // 4) Extraer nombres cola.
            ...
            Cola1 = ExtraerColaOrden(&Cola1, toupper(Let_cola), &Cola2, &ColaAux, num_usuarios);
